...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio,
  ...
  float half_fov = (eye_fov / 360.f * MY_PI);
  float top = zNear * half_fov;
  ...
  orth_scale << 1 / right, 0, 0, 0, 
    0, 1 / top, 0, 0, 
    0, 0, 2 / (zNear - zFar), 0, 
    0, 0, 0, 1;

  projection = orth_scale * orth_translate * perspective;
